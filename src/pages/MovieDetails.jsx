...
const stars = [];
  ...
  return (
    <div>
        <div className='w-full h-[621px] relative flex flex-col justify-center items-center' style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)), url(${backdrop})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }}>
            <div className='flex items-center gap-12 text-primary-text'>
                ...
                <div className='text-primary-text ml-7 mr-56'>
                    <p className='text-xl'>A fading celebrity decides to use a black market drug, a cell-replicating substance that temporarily creates a younger, better version of herself.</p>
                </div>

                <div className='flex items-center justify-between mt-7'>
                    <div className='ml-52 mt-7 flex flex-col items-center gap-2'>
                        <div className='flex gap-2 text-primary-text'>
                            <img className='w-7' src={vote} alt="" /><p className='text-xl'>Rating</p>
                        </div>
